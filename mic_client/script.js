...
async function startRecord() {
 ...
 if (!isRecording) {
   ...
   record_btn.innerHTML = '<input type="image" id="trigger" name="img" src="/webapi_client/svg/microphone_on.svg" width="50%" />'
 } else {
   ...
   record_btn.innerHTML = '<input type="image" id="trigger" name="img" src="/webapi_client/svg/microphone_off.svg" width="50%" />'
   isRecording = false
 }
}
