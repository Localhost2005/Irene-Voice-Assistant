...
async function init() {
	...
	//var ireneServer = 'https://192.168.0.47:5003';
...
window.onload = () => {
    const trigger = document.getElementById('trigger');
		trigger.onmouseup = () => {
		// Начало Смена изображения
		if (trigger.src == "/webapi_client/svg/microphone_on.svg") {
			trigger.src = "/webapi_client/svg/microphone_off.svg";
		}
		else {
			trigger.src = "/webapi_client/svg/microphone_on.svg";
		}
		// Окончание Смена изображения
